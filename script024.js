...
onload = function(){
    ...
    let torus_data = torus2(32, 32, 1.0, 2.0)

    const position = torus_data.position
    const normal = torus_data.normal
    const color = torus_data.color
    const index = torus_data.index
